...
public class  PersonListAdapter extends ArrayAdapter<Person> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String giessintervall = getItem(position).getgiessintervall();
        String familie = getItem(position).getfamilie();
        ...
        if (convertView == null)
        {
            ...
            holder.giessintervall = (TextView) convertView.findViewById( R.id.textView2 );
            holder.familie = (TextView) convertView.findViewById( R.id.textView3 );
        ...
        holder.giessintervall.setText(giessintervall) ;
        holder.familie.setText(familie) ;
